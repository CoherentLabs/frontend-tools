...
:::caution
If you plan on using the `coherent-gameface-interaction-manager` as a CDN link inside your project you need to make sure it will run with internet connection.
:::
