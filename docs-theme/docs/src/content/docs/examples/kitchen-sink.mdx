...
import { Summary, Link, Highlight } from 'coherent-docs-theme/components';

<Summary>
A <Highlight dark='yellow'>page</Highlight> <Highlight dark='red'>with</Highlight> <Highlight>a</Highlight> <Link href='aaa'>wide</Link> variety of different [Markdown syntax](https://starlight.astro.build/guides/authoring-content/) or [components](https://starlight.astro.build/components/using-components/) to show how these look together.
