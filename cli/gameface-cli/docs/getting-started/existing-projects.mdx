...
| Styles are missing after an update | The update replaced a component you had edited locally. Move your changes into `src/custom-components/` or into props, then re-run the update. |
