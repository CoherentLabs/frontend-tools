...
<Tabs syncKey="pkg">
  ...
  <TabItem label="pnpm">
    ```bash
    pnpm create gameface-app my-app --template react --default
    ```
  </TabItem>
  <TabItem label="yarn">
    ```bash
    yarn create gameface-app my-app --template react --default
    ```
  </TabItem>
  <TabItem label="npx">
    ```bash
    npx create-gameface-app my-app --template react --default
    ```
  </TabItem>
</Tabs>
