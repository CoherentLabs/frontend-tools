...
This ${callbackType} is already registered for this combination and type. To update it, first remove with the .off() method.`
  ...
  var draggable_default2 = draggable_default;
  return __toCommonJS(draggable_exports);
})();
if (typeof draggable !== 'undefined' && draggable.default) { draggable = draggable.default; }
