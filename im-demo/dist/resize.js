...
This ${callbackType} is already registered for this combination and type. To update it, first remove with the .off() method.`
  ...
  var resize_default2 = resize_default;
  return __toCommonJS(resize_exports);
})();
if (typeof resize !== 'undefined' && resize.default) { resize = resize.default; }
