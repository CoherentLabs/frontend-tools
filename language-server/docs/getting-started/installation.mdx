...
The language server extension is a `.visx` file - a VSCode extension bundle. To install it, first download the extension from the [downloads](/data-binding-autocomplete/downloads) page and then open VSCode and click on the **Extensions** icon:
