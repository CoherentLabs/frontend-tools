...
| `strictTransitions` | `boolean` | `false` | Promote [RZ002](../concepts/diagnostics.mdx#rz002) from warning to error. |
...
| Value | Behaviour |
|---|---|
| `'auto'` | Default. Emits a script only for element-mode subtrees no HTML file contained, flattens them at `DOMContentLoaded`, then stops. Reported as [RZ026](../concepts/diagnostics.mdx#rz026). |
