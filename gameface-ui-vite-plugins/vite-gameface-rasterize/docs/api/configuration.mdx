...
| `strictTransitions` | `boolean` | `false` | Promote [RZ002](/vite-gameface-rasterize/concepts/diagnostics/#rz002) from warning to error. |
...
[the single largest source of un-baked elements](/vite-gameface-rasterize/concepts/authoring/).
...
[things to watch out for](/vite-gameface-rasterize/concepts/limitations/).
...
| Value | Behaviour |
|---|---|
| `'auto'` | Default. Emits a script only for element-mode subtrees no HTML file contained, flattens them at `DOMContentLoaded`, then stops. Reported as [RZ026](/vite-gameface-rasterize/concepts/diagnostics/#rz026). |
...
[preparing your UI](/vite-gameface-rasterize/concepts/authoring/).
