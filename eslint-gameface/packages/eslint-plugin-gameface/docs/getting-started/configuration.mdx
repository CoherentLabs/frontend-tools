...
import SupportedVersions from "@components/SupportedVersions.astro";
...
## Enabling linter for a specific Gameface version \{#gf-versions\}

By default, rules use the **latest** support data shipped with the plugin. If your team targets an older Gameface release, you can specify it in the ESLint configuration:
...
<SupportedVersions manifestPath="src/content/docs/eslint-plugin-gameface/supported-versions.json" />
