...
import { withSvelteStyleBlockText } from "../../utils/walk-svelte-sfc-style-block.js";
...
export default createSvelteSfcStyleRule(
  {
    ...
    docs: {
      description:
        "In Svelte `<style>`, disallow stroke-dash* on CSS rules targeting non-path SVG shapes.",
