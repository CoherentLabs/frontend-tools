...
export default createSvelteInlineStyleRule(
  {
    ...
    docs: {
      description:
        "On Svelte `:style` / `style` attributes (string or object), disallow partial CSS keyword values per gameface-features/css/partial.json.",
  ...
  (context, sc, attr) => {
    ...
    walkSvelteStyleObjectProperties(sc, attr, (property, propLoc, valueChildren) => {
